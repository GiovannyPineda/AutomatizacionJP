...
public class MercuryTours_AutomatedTest {
    ...
    public void registerUser() throws InterruptedException {
        ...
        if(driver.findElement(registerPageLocator).isDisplayed()) {
            driver.findElement(usernameLocator).sendKeys("UserJp");
            driver.findElement(passwordLocator).sendKeys("1234");
            driver.findElement(confirmPassworLocator).sendKeys("1234");
        ...
        assertEquals("Note: Your user name is UserJp.",fonts.get(5).getText());
    ...
    public void signIn() throws InterruptedException {
        if(driver.findElement(userLocator).isDisplayed()){
            driver.findElement(userLocator).sendKeys("UserJP");
